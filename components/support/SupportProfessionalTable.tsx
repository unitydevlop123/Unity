...
const SupportProfessionalTable: React.FC<TableProps> = ({ headers, rows, children, style = 'minimal' }) => {
  const getTableClass = () => {
    switch(style) {
...
export default SupportProfessionalTable;
